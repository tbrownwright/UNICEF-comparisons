...
MainFigure_DHS <- function() {
	...
	# Get the outline of all the countries (adm0 and adm1)
	adm0_all <- readShapeSpatial(paste0("./Data/ADM/", codes_noRB$ADM_code[1], "_adm/", "gadm36_", codes_noRB$ADM_code[1], "_0.shp"))
	adm1_all <- readShapeSpatial(paste0("./Data/ADM/", codes_noRB$ADM_code[1], "_adm/", "gadm36_", codes_noRB$ADM_code[1], "_1.shp"))	

	for(i in 2:nrow(codes_noRB)) {

		# Get border lines to add
		adm0 <- readShapeSpatial(paste0("./Data/ADM/", codes_noRB$ADM_code[i], "_adm/", "gadm36_", codes_noRB$ADM_code[i], "_0.shp"))
		adm1 <- readShapeSpatial(paste0("./Data/ADM/", codes_noRB$ADM_code[i], "_adm/", "gadm36_",codes_noRB$ADM_code[i], "_1.shp"))
	...
	adm0_B <- readShapeSpatial(paste0("./Data/ADM/", codes_RB$ADM_code[1], "_adm/", "gadm36_", codes_RB$ADM_code[1], "_0.shp"))	
	adm0_R <- readShapeSpatial(paste0("./Data/ADM/", codes_RB$ADM_code[2], "_adm/", "gadm36_", codes_RB$ADM_code[2], "_0.shp"))
...
SubFigure_DHS <- function() {
	...
	# Get the outline of all the countries (adm0 and adm1)
	adm0_all <- readShapeSpatial(paste0("./Data/ADM/", codes_RB$ADM_code[1], "_adm/", "gadm36_", codes_RB$ADM_code[1], "_0.shp"))
	adm1_all <- readShapeSpatial(paste0("./Data/ADM/", codes_RB$ADM_code[1], "_adm/", "gadm36_", codes_RB$ADM_code[1], "_1.shp"))	

	for(i in 2:nrow(codes_RB)) {

		# Get border lines to add
		adm0 <- readShapeSpatial(paste0("./Data/ADM/", codes_RB$ADM_code[i], "_adm/", "gadm36_", codes_RB$ADM_code[i], "_0.shp"))
		adm1 <- readShapeSpatial(paste0("./Data/ADM/", codes_RB$ADM_code[i], "_adm/", "gadm36_", codes_RB$ADM_code[i], "_1.shp"))
